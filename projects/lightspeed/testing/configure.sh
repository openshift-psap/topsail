...
export CI_ARTIFACTS_FROM_COMMAND_ARGS_FILE=${TESTING_ANSIBLE_LLM_DIR}/command_args.yml.j2

if [[ -z "${CI_ARTIFACTS_FROM_CONFIG_FILE:-}" ]]; then
    export CI_ARTIFACTS_FROM_CONFIG_FILE=${TESTING_ANSIBLE_LLM_DIR}/config.yaml
fi
