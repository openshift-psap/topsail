...
class Repo:
    ...
    def send_cpt_notification(
        ...
        Args:
          regression_summary_path: path to the regression_summary.yaml file generated by TOPSAIL/MatrixBenchmarking
          title: the title to give to the notification message
          slack: enable or disable sending the *CPT* notification to Slack
          dry_run: if enabled, don't send any notification, just show the message in the logs
        """
        ...
        failed = send_notif.send_cpt_notification(regression_summary_path, title, slack, dry_run)
