...
def start_server(base_work_dir, platform, inference_server_native_path):
    # start the inference server (or do nothing)
    pass

def stop_server(base_work_dir, platform, inference_server_native_path):
    # stop the inference server (or do nothing)
    pass

def has_model(base_work_dir, platform, inference_server_native_path, model_name):
    # tell if the model is available locally
    # assumes start_server was called before
    pass

def pull_model(base_work_dir, platform, inference_server_native_path, model_name):
...
def run_model(base_work_dir, platform, inference_server_path, model_fname):
    # *returns the model_id to pass to llm-load-test*
    # assumes start_server was called before
    pass

def unload_model(base_work_dir, platform, inference_server_path, model_name):
    # assumes start_server was called before
    pass

def delete_models(base_work_dir, platform, inference_server_path):
