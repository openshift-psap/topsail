...
class Container_Bench:
    ...
    @AnsibleRole("container_bench_machine_first_start_benchmark")
    @AnsibleMappedParams
    def machine_first_start_benchmark(
            self,
            exec_props
    ):
        """
        Runs the podman machine first start benchmark with the given runtime
        properties of exec_props:
    ...
    @AnsibleRole("container_bench_machine_start_benchmark")
    @AnsibleMappedParams
    def machine_start_benchmark(
            self,
            exec_props
    ):
        """
        Runs the podman machine start benchmark after first boot with the given runtime
        properties of exec_props:
          binary_path:     path to the podman binary
          rootfull:        whether to run Ansible tasks as root
          additional_args: additional arguments to pass to the podman binary
