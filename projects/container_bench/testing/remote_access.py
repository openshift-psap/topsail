...
from constants import CRC_CONTAINER_BENCH_SECRET_PATH
...
def prepare():
    ...
    private_key_path = CRC_CONTAINER_BENCH_SECRET_PATH / config.project.get_config("remote_host.private_key_filename")
