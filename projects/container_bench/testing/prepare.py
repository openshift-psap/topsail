...
def prepare_windows_env_vars_podman():
    ...
    remote_access.run_with_ansible_ssh_conf(home, f"setx CONTAINERS_MACHINE_PROVIDER {provider}")
    remote_access.run_with_ansible_ssh_conf(home, f"setx HOME {home}")
