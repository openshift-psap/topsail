...
INFO: To stop the virtual machine \$ export
CONTAINERS_MACHINE_PROVIDER=$CONTAINERS_MACHINE_PROVIDER \$ podman
machine stop \$ podman machine rm # to cleanup its files and disks
