...
def generate_visualization(results_dirname, idx, generate_lts=None, upload_lts=None, analyze_lts=None, test_failed=False):
...
@entrypoint()
def generate_from_dir(results_dirname, generate_lts=None, test_failed=False):
