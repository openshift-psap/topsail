...
def apply_infiniband_configuration(isvc_data):
    """
    Apply InfiniBand configuration to ISVC containers
    ...
    logging.info(f"Applying InfiniBand configuration: {infiniband_config}")
