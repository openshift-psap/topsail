...
def get_sutest_metrics(register=False):
    ...
    all_metrics = []
    all_metrics += helper_prom_store.get_cluster_metrics(cluster_role, register=register, container_labels=SUTEST_CONTAINER_LABELS, gpu_container="kserve-container")
