...
def kserve_container_cpu_usage_max(lts_payload):
    return prom_parsing.single_max(lts_payload.results.metrics.kserve_container_cpu_usage)[0]
...
def kserve_container_memory_usage_max(lts_payload):
    return prom_parsing.single_max(lts_payload.results.metrics.kserve_container_memory_usage)[0]
