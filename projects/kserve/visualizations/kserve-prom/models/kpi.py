...
@matbench_models.Format(format="{:.2f}")
...
@matbench_models.FormatDivisor(1024*1024*1024, unit="GB", format="{:.0f}")
@matbench_models.LowerBetter
...
@matbench_models.LowerBetter
@matbench_models.KPIMetadata(help="Max GPU memory usage, for any of the GPUs | DCGM_FI_DEV_FB_USED", unit="MB")
...
@matbench_models.FormatDivisor(1024, unit="GB", format="{:.2f}")
@matbench_models.LowerBetter
@matbench_models.KPIMetadata(help="Max total GPU memory usage, for all the GPUs | DCGM_FI_DEV_FB_USED", unit="MB")
