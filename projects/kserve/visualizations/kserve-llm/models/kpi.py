...
@matbench_models.KPIMetadata(help="All values of time per output token", unit="List[ms/token]", lower_better=True)
...
@matbench_models.KPIMetadata(help="Median time per output token", unit="ms/token", lower_better=True)
...
@matbench_models.KPIMetadata(help="99th Percentile time per output token", unit="ms/token", lower_better=True)
def kserve_llm_load_test_tpot_p99(lts_payload):
    return lts_payload.results.time_per_output_token.percentile_99

# Inter token latency

@matbench_models.KPIMetadata(help="All values of inter token latency", unit="List[ms]", lower_better=True)
...
@matbench_models.KPIMetadata(help="Min inter token latency", unit="ms", lower_better=True)
...
@matbench_models.KPIMetadata(help="Max inter token latency", unit="ms", lower_better=True)
...
@matbench_models.KPIMetadata(help="Median inter token latency", unit="ms", lower_better=True)
...
@matbench_models.KPIMetadata(help="99th Percentile inter token latency", unit="ms", lower_better=True)
...
@matbench_models.KPIMetadata(help="All values of time to first token", unit="List[ms]", lower_better=True)
...
@matbench_models.KPIMetadata(help="Min time to first token", unit="ms", lower_better=True)
...
@matbench_models.KPIMetadata(help="Max time to first token", unit="ms", lower_better=True)
...
@matbench_models.KPIMetadata(help="Median time to first token", unit="ms", lower_better=True)
...
@matbench_models.KPIMetadata(help="99th Percentile time to first token", unit="ms", lower_better=True)
...
@matbench_models.KPIMetadata(help="Model load duration", unit="seconds", lower_better=True)
