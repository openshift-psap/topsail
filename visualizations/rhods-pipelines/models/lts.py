...
class PipelinesScaleTestSutestMetrics(matbench_models.ExclusiveModel):
...
class PipelinesScaleTestMetrics(matbench_models.ExclusiveModel):
    sutest: PipelinesScaleTestSutestMetrics

class PipelinesScaleTestResults(matbench_models.ExclusiveModel):
    metrics: PipelinesScaleTestMetrics
