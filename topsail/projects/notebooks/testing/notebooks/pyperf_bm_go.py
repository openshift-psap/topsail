"""
Imported from https://github.com/python/pyperformance/blob/864c3d9527a55317b41f335ba5e36a9a32840cc2/pyperformance/data-files/benchmarks/bm_go/run_benchmark.py
and updated to run standalone, without pyperf package.

Under MIT Licence, see https://github.com/python/pyperformance/blob/864c3d9527a55317b41f335ba5e36a9a32840cc2/COPYING
"""
"""
Go board game
"""
...
def do_measure(repeat, number):
    timer = timeit.Timer(stmt=versus_cpu)
    return timer.repeat(repeat=repeat, number=number)

if __name__ == "__main__":
    # not executed as part of the main test workflow
    measures = do_measure(repeat=12, number=20)
    print(measures)
