...
def register():
    NotebooksScaleTestComparisonReport()
    NotebooksPerformanceComparisonReport()

class NotebooksScaleTestComparisonReport():
    def __init__(self):
        self.name = "report: Notebooks Scale Test Comparison"
